  ...
  return <footer className="bg-gradient-to-br from-slate-900 to-emerald-900 text-white" data-magicpath-id="0" data-magicpath-path="Footer.tsx">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" data-magicpath-id="1" data-magicpath-path="Footer.tsx">
        ...
        display: "none"
          ...
          display: "none"
            ...
            display: "none"
              ...
              <p className="text-emerald-100 mb-6 max-w-md" data-magicpath-id="6" data-magicpath-path="Footer.tsx">
              ...
              <div className="space-y-3" data-magicpath-id="7" data-magicpath-path="Footer.tsx">
                ...
                x: 5
              }} className="flex items-center text-emerald-200 hover:text-white transition-colors group" data-magicpath-id="8" data-magicpath-path="Footer.tsx">
                    <contact.icon className="w-4 h-4 mr-3 text-emerald-400 group-hover:text-emerald-300" data-magicpath-id="9" data-magicpath-path="Footer.tsx" />
          ...
          <div data-magicpath-id="11" data-magicpath-path="Footer.tsx">
            ...
            once: true
              ...
              display: "none"
            }} data-magicpath-id="13" data-magicpath-path="Footer.tsx">Quick Links</h4>
              <ul className="space-y-2" data-magicpath-id="14" data-magicpath-path="Footer.tsx">
                {quickLinks.map((link, index) => <li key={index} data-magicpath-id="15" data-magicpath-path="Footer.tsx">
                  ...
                  x: 5
                }} className="text-emerald-200 hover:text-white transition-colors text-sm" data-magicpath-id="16" data-magicpath-path="Footer.tsx">
                      {link.label}
                    </motion.button>
                  </li>)}
              </ul>
          ...
          <div data-magicpath-id="17" data-magicpath-path="Footer.tsx">
            ...
            display: "none"
              ...
              <div className="flex space-x-4" data-magicpath-id="20" data-magicpath-path="Footer.tsx">
                ...
                scale: 0.95
              }} className="w-10 h-10 bg-emerald-800 rounded-lg flex items-center justify-center text-emerald-200 hover:text-white hover:bg-emerald-600 transition-colors" aria-label={social.label} data-magicpath-id="21" data-magicpath-path="Footer.tsx">
              ...
              <div className="mt-6" data-magicpath-id="23" data-magicpath-path="Footer.tsx">
                ...
                <div className="flex" data-magicpath-id="25" data-magicpath-path="Footer.tsx">
                  <input type="email" placeholder="Your email" className="flex-1 px-3 py-2 bg-emerald-800 border border-emerald-700 rounded-l-lg text-sm focus:outline-none focus:border-emerald-500 placeholder-emerald-300" data-magicpath-id="26" data-magicpath-path="Footer.tsx" />
                  <button className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 rounded-r-lg text-sm font-medium transition-colors" data-magicpath-id="27" data-magicpath-path="Footer.tsx">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        once: true
          ...
          display: "none"
        }} data-magicpath-id="30" data-magicpath-path="Footer.tsx">
            ...
            <button className="text-emerald-300 hover:text-white text-sm transition-colors" data-magicpath-id="32" data-magicpath-path="Footer.tsx">
              Terms of Service
            </button>
          </div>
        </motion.div>
