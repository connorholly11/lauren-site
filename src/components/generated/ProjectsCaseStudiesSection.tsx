...
const ProjectsCaseStudiesSection: React.FC = () => {
  ...
  return <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-blue-50" data-magicpath-id="0" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
      <div className="max-w-7xl mx-auto" data-magicpath-id="1" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
        ...
        once: true
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4" data-magicpath-id="3" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
            Case Studies & Success Stories
          </h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-6" data-magicpath-id="4" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto" data-magicpath-id="5" data-magicpath-path="ProjectsCaseStudiesSection.tsx"></div>
        </motion.div>
        ...
        <div className="space-y-8" data-magicpath-id="6" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
          ...
          once: true
        }} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 border border-slate-200" data-magicpath-id="7" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
              {/* Project Header */}
              <div className="p-8 cursor-pointer hover:bg-slate-50 transition-colors duration-300" onClick={() => toggleProject(project.id)} data-magicpath-id="8" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                  ...
                  <div className="flex items-center space-x-6" data-magicpath-id="10" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                    ...
                    <div data-magicpath-id="12" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      <div className="flex items-center space-x-3 mb-2" data-magicpath-id="13" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h3 className="text-2xl font-bold text-slate-900" data-magicpath-id="14" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{project.title}</h3>
                        <span className="px-3 py-1 bg-blue-50 text-blue-700 text-sm font-medium rounded-full border border-blue-200" data-magicpath-id="15" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          {project.category}
                        </span>
                      </div>
                      <p className="text-lg text-slate-600 leading-relaxed max-w-2xl mb-3" data-magicpath-id="16" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        {project.summary}
                      </p>
                      <div className="flex items-center space-x-4 text-sm text-slate-500" data-magicpath-id="17" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                ...
                duration: 0.3
                    ...
                    <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center" data-magicpath-id="28" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      {expandedProject === project.id ? <ChevronUp className="w-5 h-5 text-slate-600" data-magicpath-id="29" data-magicpath-path="ProjectsCaseStudiesSection.tsx" /> : <ChevronDown className="w-5 h-5 text-slate-600" data-magicpath-id="30" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />}
                    </div>
                  </motion.div>
                </div>
              </div>
              ...
              duration: 0.5
            }} className="border-t border-slate-200" data-magicpath-id="32" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                    <div className="p-8 bg-slate-50 space-y-10" data-magicpath-id="33" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      
                      {/* Challenges Section */}
                      <div data-magicpath-id="34" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h4 className="text-xl font-bold text-slate-900 mb-4 flex items-center" data-magicpath-id="35" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      ...
                      <div data-magicpath-id="41" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h4 className="text-xl font-bold text-slate-900 mb-4 flex items-center" data-magicpath-id="42" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          <CheckCircle className="w-5 h-5 mr-2 text-green-500" data-magicpath-id="43" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />
                        ...
                        <div className="space-y-4" data-magicpath-id="44" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          {project.solutions.map((solution, idx) => <div key={idx} className="flex items-start space-x-4" data-magicpath-id="45" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                              <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-sm" data-magicpath-id="46" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                {solution.step}
                              </div>
                              <div className="flex-1" data-magicpath-id="47" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                <h5 className="text-lg font-semibold text-slate-900 mb-2" data-magicpath-id="48" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{solution.title}</h5>
                                <p className="text-slate-600 mb-2 leading-relaxed" data-magicpath-id="49" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{solution.description}</p>
                                <div className="bg-green-50 rounded-lg p-3 border border-green-100" data-magicpath-id="50" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  <p className="text-green-800 text-sm" data-magicpath-id="51" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      ...
                      <div data-magicpath-id="53" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h4 className="text-xl font-bold text-slate-900 mb-4 flex items-center" data-magicpath-id="54" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          <ArrowRight className="w-5 h-5 mr-2 text-blue-500" data-magicpath-id="55" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />
                          Before vs After Results
                        </h4>
                        <div className="grid md:grid-cols-3 gap-4" data-magicpath-id="56" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          {project.beforeAfter.map((comparison, idx) => <div key={idx} className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 border border-slate-200" data-magicpath-id="57" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                              <h5 className="font-semibold text-slate-900 mb-3" data-magicpath-id="58" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{comparison.metric}</h5>
                              <div className="space-y-2" data-magicpath-id="59" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                ...
                                <div className="flex justify-between items-center" data-magicpath-id="63" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  <span className="text-green-600 font-medium text-sm" data-magicpath-id="64" data-magicpath-path="ProjectsCaseStudiesSection.tsx">After:</span>
                                  <span className="text-green-800 font-bold" data-magicpath-id="65" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{comparison.after}</span>
                                </div>
                                <div className="pt-2 border-t border-slate-200" data-magicpath-id="66" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  <div className="text-center" data-magicpath-id="67" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-2 py-1 rounded-full text-xs font-bold" data-magicpath-id="68" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                      ...
                      <div data-magicpath-id="69" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h4 className="text-xl font-bold text-slate-900 mb-4 flex items-center" data-magicpath-id="70" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          <BarChart3 className="w-5 h-5 mr-2 text-purple-500" data-magicpath-id="71" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />
                      ...
                      return <div key={idx} className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-4 text-center border border-slate-200" data-magicpath-id="73" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center mx-auto mb-3" data-magicpath-id="74" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  <IconComponent className="w-6 h-6 text-white" data-magicpath-id="75" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />
                                </div>
                                <div className="text-2xl font-bold text-slate-900 mb-1" data-magicpath-id="76" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{result.value}</div>
                                <div className="text-sm font-medium text-slate-700 mb-1" data-magicpath-id="77" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{result.metric}</div>
                                <div className="text-xs text-slate-600 leading-relaxed" data-magicpath-id="78" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{result.description}</div>
                              </div>;
                    })}
                        </div>
                      </div>
                      ...
                      <div data-magicpath-id="79" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                        <h4 className="text-xl font-bold text-slate-900 mb-4 flex items-center" data-magicpath-id="80" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          <Calendar className="w-5 h-5 mr-2 text-orange-500" data-magicpath-id="81" data-magicpath-path="ProjectsCaseStudiesSection.tsx" />
                          Project Timeline
                        </h4>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4" data-magicpath-id="82" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          {project.timeline.map((phase, idx) => <div key={idx} className="relative" data-magicpath-id="83" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                              <div className="bg-orange-50 rounded-xl p-4 border border-orange-100" data-magicpath-id="84" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                <div className="flex items-center justify-between mb-3" data-magicpath-id="85" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  <h5 className="font-semibold text-orange-900 text-sm" data-magicpath-id="86" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{phase.phase}</h5>
                                  <span className="text-xs bg-orange-200 text-orange-800 px-2 py-1 rounded-full" data-magicpath-id="87" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                    {phase.duration}
                                  </span>
                                </div>
                                <ul className="space-y-1" data-magicpath-id="88" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                  {phase.activities.map((activity, actIdx) => <li key={actIdx} className="text-xs text-orange-700 flex items-start" data-magicpath-id="89" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                                      <div className="w-1 h-1 bg-orange-600 rounded-full mt-1.5 mr-2 flex-shrink-0" data-magicpath-id="90" data-magicpath-path="ProjectsCaseStudiesSection.tsx"></div>
                                      {activity}
                                    </li>)}
                                </ul>
                              </div>
                              {idx < project.timeline.length - 1 && <div className="hidden lg:block absolute top-1/2 -right-2 w-4 h-0.5 bg-orange-300" data-magicpath-id="91" data-magicpath-path="ProjectsCaseStudiesSection.tsx"></div>}
                            </div>)}
                        </div>
                      </div>

                      {/* Client Testimonial */}
                      {project.testimonial && <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-6 text-white" data-magicpath-id="92" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                          ...
                          <div className="flex items-center space-x-3" data-magicpath-id="94" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                            ...
                            <div data-magicpath-id="97" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
                              ...
                              <div className="text-blue-100 text-sm" data-magicpath-id="99" data-magicpath-path="ProjectsCaseStudiesSection.tsx">{project.testimonial.role}</div>
                            </div>
                          </div>
                        </div>}
        ...
        once: true
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-8 text-white" data-magicpath-id="101" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
            ...
            behavior: 'smooth'
          })} className="inline-flex items-center px-6 py-3 bg-white text-blue-600 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" data-magicpath-id="104" data-magicpath-path="ProjectsCaseStudiesSection.tsx">
              Start Your Campaign
